...
const ReviewScore = ({ item }) => {
  ...
  return (
    <div className='reviewScore'>
      <ScoreApart
        name={'Cleanliness'}
        widthStyle={{ width: `${clean}%` }}
        total={item.scorecleanliness}
      />
      <ScoreApart
        name={'Accuracy'}
        widthStyle={{ width: `${Accuracy}%` }}
        total={item.scoreaccuracy}
      />
      <ScoreApart
        name={'Communication'}
        widthStyle={{ width: `${Communication}%` }}
        total={item.scorecommunication}
      />
      <ScoreApart
        name={'Location'}
        widthStyle={{ width: `${location}%` }}
        total={item.scorelocation}
      />
      <ScoreApart
        name={'Check-in'}
        widthStyle={{ width: `${checkin}%` }}
        total={item.scorecheckin}
      />
      <ScoreApart
        name={'Value'}
